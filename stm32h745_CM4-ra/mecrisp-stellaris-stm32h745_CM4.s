...
@ uncomment this to set the default comms to use swd instead of serial
...
@ this version uses flash in the upper Bank2 region
@ -----------------------------------------------------------------------------

@ Konstanten für die Größe des Ram-Speichers
@ constants for the size of the RAM memory
.equ RamAnfang, 0x38000800 @ Start of AHB SRAM4  - Porting: Change this !
.equ RamEnde,   0x38008800 @ End   of RAM. 32 kb. - Porting: Change this !

@ Konstanten für die Größe und Aufteilung des Flash-Speichers
@ Constants for the size and distribution of the flash memory
.equ Kernschutzadresse,     0x081E0000 @ Darunter wird niemals etwas geschrieben ! Mecrisp core never writes flash below this address.
@ Note that the H743/5 can only erase flash in 128K sectors, this is why we have so much
.equ FlashDictionaryAnfang, 0x081E0000 @ 128  kb für den Kern reserviert. 128kb Flash reserved for core.
.equ FlashDictionaryEnde,   0x08200000 @ 128kb Platz für das Flash-Dictionary 128kb Flash available. Porting: Change this !
...
@ -----------------------------------------------------------------------------
   ...
   welcome " for STM32H745_CM4 v0.4 by Matthias Koch et al"
